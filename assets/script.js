...
$("#search-button").on('click', function () {
  ...
  // var weatherURL = "https://api.openweathermap.org/data/2.5/forecast?city=" + citySearch + ",us&units=imperial&appid=00604984263164d160d696afed305b97";
  ...
  $(".itineraryButtonEats").on("click", function (){
    var data =  $(this).data();
    var Eats = restaurantArr[data.index];
    console.log(event);
